...
const TransInOtherLang = ({
  ...
  return (
    <div className="fixed top-0 left-0 bottom-0 right-0 w-full h-screen flex items-end md:items-center lg:mt-[0px] bg-[#252525b0] justify-center z-[21]">
      <ToastContainer />
      <div className="h-[536px]  lg:static absolute bottom-0 px-[22px] w-full sm:w-[90%] bg-[#fff] lg:bg-[#FAFAFA]  lg:w-[430px]  md:mx-auto rounded-[8px]">
        <div className=" relative">
          {/* close popup */}
          {/* close popup */}
          <div className="hidden lg:block absolute top-[-30px] right-[-8%] ml-4 ">
            <img
              src={crossIcon}
              alt=""
