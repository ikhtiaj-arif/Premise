...
// import beatSr from "../../../../../img/add_beat_sr.png";

// const TriggerPopupComment = ({ onClose }) => {
//   const handleCheckboxChange = (e) => {
//     const isChecked = e.target.checked;
//     if (isChecked) {
//       localStorage.setItem("ppdoNotShowCommentPopup", "true");
//     } else {
//       localStorage.removeItem("ppdoNotShowCommentPopup");
//     }
//   };
...
//                 1. That you can add brainstorms to Beat Sheet!
//               </h2>
//               <img src={beatSr} alt="" className="max-w-[403.58px] " />
//               <h2 className="text-[16px] font-medium text-[#252525] translate-y-3 text-center">
...
// export default TriggerPopupComment;
