...
const CongratsPop = ({ popClose,Sale ,Names }) => {
  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center mt-[80px] lg:mt-[0px] bg-[#252525b0] justify-center z-[1] ">
      ...
      <div className=" h-[100vh] lg:h-[500px] mb-[20px] px-[22px] lg:mb-0  lg:mt-[100px] xl:mt-[85px] w-full bg-[#fff] lg:bg-[#FAFAFA]  lg:w-[605px]  md:mx-auto relative lg:rounded-[8px]">
        ...
        <p className="ml-[40px] text-left text-[14px] leading-[21px] my-[2px] font-[400]  text-[#252525] ">
          The monetizing preferences of the Premise Project are updated and
          interested translator has been informed
        </p>
        <p className="ml-[40px] text-left text-[14px] leading-[21px] my-[2px] font-[400]  text-[#252525] ">
          Your share of the translations proceeds will be transferred to your
          bank account as soon as the Premise Project is translated.
        </p>
        </div>
        )}
      </div>
