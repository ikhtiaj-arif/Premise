...
const CongratsPopup = ({
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center mt-[80px] lg:mt-[0px] bg-[#252525b0] justify-center z-[21] ">
      <ToastContainer />
      <div className=" h-[50vh] lg:h-[375px] mb-[20px] px-[22px] lg:mb-0  lg:mt-[100px] xl:mt-[85px] w-full bg-[#fff] lg:bg-[#FAFAFA]  lg:w-[605px]  md:mx-auto relative lg:rounded-[8px]">
        ...
        <div className="flex flex-col  items-center justify-start">
          ...
          <h2 className="font-[500] text-[16px] pt-2  text-center ">
        ...
        <div className="h-[1px] mt-2 w-[70%] mx-auto bg-[#a1a1a1]" />

        <p className="text-center text-[14px] mt-[40px] leading-[21px]  font-[400]  text-[#252525] "></p>
        {requestType === "sale" ? (
          <div>
            <p className="mx-[40px] text-left text-[14px] leading-[21px] my-[2px] font-[400]  text-[#252525] ">
