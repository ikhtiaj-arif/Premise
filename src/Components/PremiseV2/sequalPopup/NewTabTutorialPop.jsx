                    ...
                    <button
                      ...
                      className={`w-[130px] h-[32px] ${
                        currentPopup === 1
                          ...
                          : "bg-[linear-gradient(30deg,#741CFF,#00c3ff)] cursor-pointer"
                      } bg-[linear-gradient(30deg,#741CFF,#00c3ff)]
 text-white rounded-[8px] px-[12px] text-[14px] font-[600] flex gap-[12px] items-center justify-center`}
                    >
                      <FaArrowLeft />
                      Previous
                    </button>
                  ...
                  <button
                    ...
                    className="w-[130px] h-[32px]  bg-[linear-gradient(30deg,#741CFF,#00c3ff)]
 text-white rounded-[8px] px-[12px] text-[14px] font-[600] flex gap-[12px] items-center justify-center"
                  >
                    Next
                    <FaArrowRight />
                ...
                <button
                  onClick={handleNextPopup}
                  className="w-[100px] h-[32px] bg-[linear-gradient(30deg,#741CFF,#00c3ff)] text-white rounded-[8px] px-[12px] text-[14px] font-[600] flex gap-[12px] items-center justify-center"
                >
                  Let's start!
                </button>
              )}
