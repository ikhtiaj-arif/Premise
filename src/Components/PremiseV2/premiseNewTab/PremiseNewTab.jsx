      ...
      <div className=" fixed top-[70px] left-1/2 -translate-x-1/2 w-full  ">
        ...
        commentsData ? (
          <div className="w-[95%]  max-w-[1445px] mx-auto">
            ...
            />
            <div className="w-full lg:hidden h-[70vh] overflow-y-auto relative">
              {/* Left Sidebar */}
              ...
              <div
                ref={lastCommentRef}
                className="w-full relative lg:h-[80vh] lg:overflow-y-auto lg:shadow-[0px_0px_20.6px_0px_rgba(0,0,0,0.15)] lg:ml-3 lg:rounded-2xl"
              >
