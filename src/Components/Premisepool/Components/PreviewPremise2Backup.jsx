                ...
                <div className="text-[12px] grid grid-cols-12 gap-x-[6px] md:gap-x-[12px] gap-y-[4px]  px-[16px] md:px-0 lg:px-0 mt-[8px] md:mt-[-5px]">
                  ...
                  <div
                    className={`h-[31px] relative col-span-4 ${
                      ...
                      subGeneraItem ? "border-[#00c3ff]" : "border-[#EAEAEA]"
                    }`}
                  >
                    <select
                      className="block appearance-none bg-[#fafafa] h-[27px] rounded-[4px]  w-full px-[8px] text-[12px] md:!text-[14px] leading-tight focus:outline-none"
              ...
              >
                {!charSaveDisable && (
                  <div
                    ...
                    className={` text-[#00c3ff] cursor-pointer mr-[12px]  h-[32px] px-[10px] text-[14px] font-[500] border border-[#fafafa] border-b-[#00c3ff]
                  `}
                  >
                ...
                {finalSubmitLoading ? (
                  ...
                  <div
                    ...
                    disabled={finalSubmitLoading}
                    className={` text-white flex justify-center items-center cursor-pointer rounded-[8px] h-[32px] px-[28px] text-[14px] font-[600] ${"bg-[#00c3ff]"}`}
                  >
                    Post
                  </div>
                )}
