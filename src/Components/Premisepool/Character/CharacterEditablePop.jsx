...
const CharacterEditablePop = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="relative bg-[#fafafa] py-8 px-6 md:px-[56px] rounded-lg shadow-lg w-full lg:w-[950px] h-[89vh] md:h-[396px] mt-[85px] ">
        <button
        ...
        {/* 3 Column Layout */}
        <div className="max-h-[68vh] overflow-auto md:h-auto">
          {finalAICharacters?.length > 0 && (
            <p className=" text-[#252525] text-[16px] font-[600] mb-[10px]">
              Generated By Ida
            </p>
          )}
