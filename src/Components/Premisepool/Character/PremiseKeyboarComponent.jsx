...
import cyrillicLatinLayout from "../Components/layout/cyrillicLatinLayout";
import cyrillicLayout from "../Components/layout/cyrillicLayout";
import cyrillicMongolianLayout from "../Components/layout/cyrillicMongolianLayout";
import geezLayout from "../Components/layout/geezLayout";
import gujaratiLayout from '../Components/layout/gujaratiLayout'
import khmerLayout from "../Components/layout/khmerLayout";
import laoLayout from "../Components/layout/laoLayout";
import sinhalaLayout from "../Components/layout/sinhalaLayout";
import tamilLayout from "../Components/layout/tamilLayout";
...
const PremiseKeyboarComponent = ({ language = "English", onKeyPress, layoutName }) => {
...
export default PremiseKeyboarComponent;
