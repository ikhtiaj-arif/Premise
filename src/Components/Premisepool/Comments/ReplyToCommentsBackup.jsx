          ...
          <div className="flex gap-[8px]">
            ...
            <div className="border w-[78%] md:w-[86%] lg:w-[89%] border-[##EAEAEA] bg-[#fafafa] rounded-[8px] p-1 ">
              <div className="flex justify-between my-1 relative">
                {reply.add_to_beat && owner === user ? (
                  <div className="text-[#a4a4a4] pl-[4px] pt-[4px] h-[15px] flex gap-1 lg:gap-2 items-center">
                    {reply?.user?.id === 1 ? (
            ...
            {reply.add_to_beat ? (
              <>
                {(owner === user || reply?.user?.id === owner) && (
                  <button className="w-[48%] cursor-auto md:w-[24%]">
                    <p className="text-[12px] text-[#616161] italic  font-[400] leading-[14.52px] ">
                      Added to Beat Sheet
                    </p>
                  </button>
                )}
