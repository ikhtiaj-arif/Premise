        ...
        <div className="modal_css z-10 top-26   ">
          <div className="rounded-[8px] w-[920px] h-[547px] bg-[#FAFAFA]">
            <div className="h-[27px] relative w-[920px] rounded-t-xl font-[500]  flex flex-row-reverse items-center px-3">
              <button onClick={()=> setBeatSheetGenPop(false)} className="btn-sm hover:shadow-md shadow-[#252525] border-none text-white bg-[#EE3C4D] btn-circle absolute right-[-13px] top-[-13px]">
                ✕
              </button>
            </div>
            ...
            <div className="px-[33px]">
              <div className="">
                <h5 className="text-[14px] font-[400] pb-[15px]">
                  <span className="pl-[20px]">A</span> beat describes a moment or event which forwards to story or
                  reveals something significant about the characters or plot. It
                  clearly brings out who does what and defines the outcome of
                  the scene in a clear, impactful,and engaging way to connect
                  the audience with the characters and maintain engagement and
                  coherence in the narrative.
                </h5>
                <h5 className="text-[14px] font-[400]">
                  <span className="pl-[20px]">The</span> beat description is in present continuous tense, concise,
                  in active voice, precisely detailing the trigger, subject,
                  actions, settings and emotions. To control the rhythm and
                  pace, Short and long sentences are used to increase tension or
              ...
              <div>
                <h3 className="text-[14px] font-[600] pb-[13px]">Select and Edit one of the following for Generating a Scene</h3>
              </div>
              <div>
                <div className="w-[853px] mb-[5px] rounded-[6px] px-[16px] py-[10px] bg-[#EAEAEA] h-[42px] border flex items-center gap-[10px]">
                    <input onClick={()=> setRegardingOutput('one')} checked={regardingOutput === 'one'} type="radio" name="" id="" className="" />
                    <textarea maxLength={400} type="text" value='Repopulated original Editable Comment Display' className="w-full  resize-none outline-none bg-[#EAEAEA] h-full text-[14px]"  />
                </div>
              ...
              <div className="flex justify-end items-center gap-[16px] mt-[20px]">
                ...
                <button className="w-[69px] h-[32px] bg-[#33B0CA] text-white rounded-[4px] text-[14px] font-[600]">
                    Next
                </button>
              </div>
            </div>
